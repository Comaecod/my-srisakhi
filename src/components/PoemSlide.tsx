...
export const PoemSlide = ({
  ...
  return (
    <motion.div
      key={`step-${index}`}
      className={`cursor-pointer max-w-7xl mx-auto px-6 py-16 md:py-24 
      flex flex-col xl:flex-row 
      ${isReverse ? 'xl:flex-row-reverse' : ''} 
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
        className='relative w-64 sm:w-72 md:w-80 lg:w-96 aspect-square rounded-2xl overflow-hidden shadow-xl'>
        <Image
          src={slide.image}
          alt={slide.alt}
          fill
